...
class VSCodelikeIDE(tk.Tk):
    ...
    def load_language_configs(self):
        return {
            "python": {"ext": ".py", "keywords": ["def", "if", "else", "for", "while", "import", "class", "try", "except", "with"],
                      "comment": r'#.*$', "runner": [sys.executable, "{file}"], "builtins": ["print", "len", "range", "input"]},
            "javascript": {"ext": ".js", "keywords": ["function", "if", "else", "for", "let", "const", "var", "return", "async", "await"],
                          "comment": r'//.*$', "runner": ["node", "{file}"], "builtins": ["console.log", "alert", "fetch"]},
            "html": {"ext": ".html", "keywords": ["html", "head", "body", "div", "script", "style", "title", "p", "a", "img"],
                    "comment": r'<!--[\s\S]*?-->', "runner": None, "builtins": []},
            "java": {"ext": ".java", "keywords": ["public", "class", "static", "void", "if", "else", "for", "int", "new", "return"],
                    "comment": r'//.*$', "runner": ["javac", "{file}", "&&", "java", "{class}"], "builtins": ["System.out.println", "Math.random"]},
            "c": {"ext": ".c", "keywords": ["int", "float", "if", "else", "for", "while", "return", "void", "struct", "char"],
                 "comment": r'//.*$', "runner": ["gcc", "{file}", "-o", "a.exe", "&&", "a.exe"], "builtins": ["printf", "scanf"]},
            "cpp": {"ext": ".cpp", "keywords": ["int", "float", "if", "else", "for", "while", "return", "class", "public", "private"],
                   "comment": r'//.*$', "runner": ["g++", "{file}", "-o", "a.exe", "&&", "a.exe"], "builtins": ["cout", "cin"]}
        }
